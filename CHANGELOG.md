...
### Fixed
- **Fallback font baseline alignment**: Fix vertical misalignment when fallback fonts are used
  - Calculate reference alphabetic baseline from main font
  - Adjust each character's position based on its alphabetic baseline
  - Ensures consistent vertical alignment across different fonts
