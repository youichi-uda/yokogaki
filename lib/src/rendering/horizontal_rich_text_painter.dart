...
import '../widgets/horizontal_rich_text.dart';
...
/// Custom painter for horizontal Japanese rich text with multiple styles
class HorizontalRichTextPainter extends CustomPainter {
  final String text;
  ...
  @override
  bool shouldRepaint(HorizontalRichTextPainter oldDelegate) {
